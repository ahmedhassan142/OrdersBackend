...
exports.getReviewRequestContent = void 0;
const userservice_1 = require("../services/userservice");
const product_1 = require("../services/product");
const getReviewRequestContent = (order) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Normalize order data (convert ObjectIds to strings)
        const normalizedOrder = Object.assign(Object.assign({}, order), { _id: typeof order._id === 'object' ? order._id.toString() : order._id, items: order.items.map(item => (Object.assign(Object.assign({}, item), { productId: typeof item.productId === 'object' ? item.productId.toString() : item.productId, product: Object.assign(Object.assign({}, item.product), { data: Object.assign(Object.assign({}, item.product.data), { _id: typeof item.product.data._id === 'object'
                            ? item.product.data._id.toString()
                            : item.product.data._id }) }) }))) });
        // Prepare products for review
        const productsForReview = yield prepareProductsForReview(normalizedOrder);
        // Get recipient email
        // @ts-ignore
        const recipientEmail = yield (0, userservice_1.getRecipientEmail)(normalizedOrder);
        if (!recipientEmail) {
...
exports.getReviewRequestContent = getReviewRequestContent;
// Helper functions
function prepareProductsForReview(order) {
    return __awaiter(this, void 0, void 0, function* () {
        const baseUrl = process.env.FRONTEND_URL;
        const itemsWithDetails = yield Promise.all(order.items.map((item) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield (0, product_1.fetchProductDetails)(productId);
...
function generateTextContent(order, products) {
...
function generateHtmlContent(order, products) {
    const orderIdShort = order._id.toString().substring(0, 8);
